...
class Ui_Dialog_BallsNum(object):
    def setupUi(self, Dialog_BallsNum):
        ...
        self.pushButton_refresh = QPushButton(Dialog_BallsNum)
        self.pushButton_refresh.setObjectName(u"pushButton_refresh")
        self.pushButton_refresh.setMinimumSize(QSize(0, 38))
        self.pushButton_refresh.setMaximumSize(QSize(200, 16777215))
        font2 = QFont()
        font2.setPointSize(10)
        font2.setBold(True)
        self.pushButton_refresh.setFont(font2)
        self.pushButton_refresh.setStyleSheet(u"background:rgb(0, 245, 0)")
        ...
        self.pushButton_start = QPushButton(Dialog_BallsNum)
        self.pushButton_start.setObjectName(u"pushButton_start")
        self.pushButton_start.setMinimumSize(QSize(0, 38))
        self.pushButton_start.setMaximumSize(QSize(200, 16777215))
        self.pushButton_start.setFont(font2)
        self.pushButton_start.setStyleSheet(u"background:rgb(245, 0, 0)")

        self.gridLayout.addWidget(self.pushButton_start, 4, 1, 1, 1)
    ...
    def retranslateUi(self, Dialog_BallsNum):
        ...
        self.pushButton_refresh.setText(QCoreApplication.translate("Dialog_BallsNum", u"\u5237\u65b0(refresh)", None))
        self.label.setText(QCoreApplication.translate("Dialog_BallsNum", u"\u8bf7\u786e\u8ba4\u8d77\u70b9\u67098\u9897\u7403", None))
        self.pushButton_start.setText(QCoreApplication.translate("Dialog_BallsNum", u"\u7ee7\u7eed\u5f00\u59cb(start)", None))
    # retranslateUi

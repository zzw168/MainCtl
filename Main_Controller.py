...
def json_txt():
    if json_to_txt():
        ui.textBrowser_save_msg.append(succeed('区域文件转TXT成功！'))
    else:
        ui.textBrowser_save_msg.append(fail('区域文件转TXT失败！'))

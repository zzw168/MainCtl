...
let qius = config.qiu||QueryParams('qiu')||'8'
const renderFn = (data,cb)=>{
$("#wrap").html(`
<div class=" animate__animated animate__backInRight ">
      <div class="topView flex-box center">
        <div class="qh whiteA">Race Results <span class="padLeft ">#${data.qh}</span></div>
        </div>
     </div>
     <div class="rankView flex-box between ballNum${qius}" >
        <div class="rankItem "  >
        ...
        <div class="view-right animate__animated animate__bounceInRight">
          ...
          <div class="pathBox flex-box center column animate__animated animate__backInRight">
           <div class="coutBox" >
            ...
            <img id="sphere" class="pathImg" src="./assets/sd/${config.sd||QueryParams('sd')||'9'}.png" alt="" />
            <div class=" flex-box between TextpadLeft wrap grid" > 
             <div class="rtxt fl  ">
                   <div> LENGTH</div>
                   <div class="rtxt1">
                            ${rtxt1}
         ...
         ">
                ...
                <div class="box-right flip-card-back flex-box between">
                    <div class="ball  center  flex-box animate__animated flex">
                        ...
                        <img src="../common/img${data.rank.length||8}/${el.mc}.png"  alt="" />
                    </div>
